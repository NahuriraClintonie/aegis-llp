...
export default function CareersPage() {
  ...
  return (
    <div className={`${styles.minHeightScreen} ${styles.bgWhite}`}>
      {/* Hero Section */}
      <section className={`${styles.applicationFormBg} ${styles.sectionPadding}`}>
        <div className={styles.containerCustom}>
          <div className={`${styles.maxWidth4xl} ${styles.mxAuto} ${styles.textAlign}`}>
            ...
            <div className={`${styles.gridCols1} ${styles.mdGridCols3} ${styles.gap8} ${styles.marginTop12}`}>
              <div className={styles.divTextAlign}>
                ...
                <p className={styles.pTextSlate600Mb}>Work alongside talented professionals from diverse member companies</p>
              </div>
              <div className={styles.divTextAlign}>
                <div className={`${styles.divInlineFlex} ${styles.divItemsCenter} ${styles.divJustifyCenter} ${styles.divW16} ${styles.divH16} ${styles.divBgSlate100} ${styles.divRoundedFull} ${styles.divMarginBottom4}`}>
                ...
                <p className={styles.pTextSlate600Mb}>Flexible working arrangements and respect for personal time</p>
              </div>
              <div className={styles.divTextAlign}>
                <div className={`${styles.divInlineFlex} ${styles.divItemsCenter} ${styles.divJustifyCenter} ${styles.divW16} ${styles.divH16} ${styles.divBgSlate100} ${styles.divRoundedFull} ${styles.divMarginBottom4}`}>
                ...
                <p className={styles.pTextSlate600Mb}>Modern office space in the heart of Tokyo with excellent connectivity</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className={`${styles.gridCols1} ${styles.lgGridCols2} ${styles.gap8}`}>
            {jobOpenings.map((job) => (
              <div key={job.id} className={`${styles.jobCard} ${styles.jobCardHover}`}>
                <div className={`${styles.flexJustifyBetween} ${styles.itemsStartMb4}`}>
                  <div>
                    <h3 className={`${styles.h3TextXl} ${styles.h3FontSemiboldMb2}`}>{job.title}</h3>
                    <div className={`${styles.flexItemsCenter} ${styles.textSm} ${styles.textSlate600Mb2}`}>
                  ...
                  <span className={styles.textXsTextSlate500}>Posted {new Date(job.posted).toLocaleDateString()}</span>
                </div>

                <p className={`${styles.pTextSlate600TextSm} ${styles.leadingRelaxedMb6}`}>{job.description}</p>

                <div className={`${styles.flexCol} ${styles.smFlexRow} ${styles.gap3}`}>
                  <button
                ...
                {selectedJob === job.id && (
                  <div className={styles.jobDetailsSection}>
                    <div className={`${styles.gridCols1MdGridCols2} ${styles.gap6}`}>
                      <div>
                        <h4 className={`${styles.h4FontSemibold} ${styles.h4TextSlate900} ${styles.h4Mb3}`}>Requirements</h4>
                        <ul className={styles.spaceY2}>
                          {job.requirements.map((req, index) => (
                            <li key={index} className={`${styles.textSmTextSlate600} ${styles.flexItemsStart}`}>
                      ...
                      <div>
                        <h4 className={`${styles.h4FontSemibold} ${styles.h4TextSlate900} ${styles.h4Mb3}`}>Responsibilities</h4>
                        <ul className={styles.spaceY2}>
      ...
      {/* Application Form */}
      <section id="application-form" className={`${styles.applicationFormBg} ${styles.sectionPadding}`}>
        <div className={styles.containerCustom}>
          <div className={`${styles.applicationFormMaxW2xl} ${styles.applicationFormMxAuto}`}>
            ...
            <div className={styles.applicationFormCard}>
              <form onSubmit={handleApplicationSubmit} className={styles.applicationFormSpaceY6}>
                ...
                <div className={styles.applicationFormBtnContainer}>
                  <button type="submit" className={`${styles.btnPrimary} ${styles.flex1} ${styles.flexItemsCenter} ${styles.divJustifyCenter}`}>
                    Submit Application
                    <Send className={`${styles.iconH4W4} ${styles.ml2}`} />
                  </button>
                  <button type="button" className={`${styles.btnSecondary} ${styles.flexItemsCenter} ${styles.divJustifyCenter}`}>
                    <Download className={`${styles.iconH4W4} ${styles.mr2}`} />
                    Upload Resume
                  </button>
                </div>
              </form>
      ...
      <section className={styles.sectionPadding}>
        <div className={styles.containerCustom}>
          <div className={styles.textCenterMb12}>
            ...
            <p className={`${styles.companyCultureP} ${styles.pTextLg} ${styles.pTextSlate600Mb}`}>
              Discover what makes our workplace special and why our team members love being part of the AEGIS family.
            </p>
          </div>

          <div className={`${styles.companyCultureGrid} ${styles.gap8}`}>
            <div className={styles.divTextAlign}>
              <div className={`${styles.companyCultureCard} ${styles.bgSlate100} ${styles.divMarginBottom4}`}>
                <h3 className={`${styles.companyCultureCardH3} ${styles.h3FontSemibold} ${styles.h3TextColor} ${styles.h3MarginBottom2}`}>
                  Professional Development
                </h3>
                <p className={`${styles.companyCultureCardP} ${styles.pTextSlate600TextSm}`}>
